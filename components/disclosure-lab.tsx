...
const chartConfig = {
  transaction: { label: 'Trade-date estimate', color: '#b38dff' },
  disclosure: { label: 'After disclosure', color: '#a9e76c' },
  benchmark: { label: 'Benchmark', color: '#7b95ad' },
};
...
export default function DisclosureLab() {
  ...
  return (
    <main className="research-app dark">
          ...
          <aside className="configuration panel">
            ...
            <div className="config-fields">
              ...
              <p className="control-note">
                Fixed share of starting cash per purchase. Fractional shares.
                Cash earns 0%.
              </p>
                ...
                <div className="advanced-fields">
                  ...
                  <Choice
                    ...
                    options={[7, 15, 30, 45, 90, 3650].map((n) => [
                      n,
                      n === 3650 ? 'No practical cap' : `${n} calendar days`,
                    ])}
                  />
                  <Choice
          ...
          <section className="results">
            ...
            {!r && !loadError && !result?.error && (
              <output className="panel loading-result">
                ...
                <p>Calculating both portfolios from the research snapshot.</p>
              </output>
            )}
            {r && snapshot && (
              <>
                <div className="result-top">
                  <div>
                    <p className="eyebrow">EXPERIMENT / {config.benchmark}</p>
                    <h2>{name}</h2>
                    <p>
                ...
                <div className="metrics">
                  <article className="metric-card purple">
                    ...
                    <span>{money(r.transaction.finalEquity)} ending value</span>
                    <p>
                  ...
                  <article className="metric-card green">
                    ...
                    <span>{money(r.disclosure.finalEquity)} ending value</span>
                    <p>
                      First open after filing
                      {config.delay ? ` + ${config.delay} sessions` : ''}.<br />
                  ...
                  <article className="metric-card benchmark">
                    ...
                    <span>{money(r.curve.at(-1)!.benchmark)} ending value</span>
                    <p>
                ...
                <div className="panel chart-panel">
                  <div className="chart-header">
                    <div>
                      ...
                      <p>
                        Portfolio value · adjusted-price total-return estimate
                      </p>
                    </div>
                    <div className="excess">
                      ...
                      <strong>
                        {r.disclosure.totalReturn - r.benchmarkReturn >= 0
                          ? '+'
                          : ''}
                        {(r.disclosure.totalReturn - r.benchmarkReturn).toFixed(
                          2,
                        )}{' '}
                        <small>pp</small>
                      </strong>
                  ...
                  <ChartContainer config={chartConfig} className="equity-chart">
                    <LineChart
                      data={r.curve}
                  ...
                  <div className="chart-stats">
                    ...
                    <div>
                      ...
                      <strong>
                        ...
                        <small>
                          {' '}
                          public / {r.transaction.positions.length} trade-date
                        </small>
                      </strong>
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <p>
                      ...
                      {r.disclosure.positions.length < 30
                        ...
                        : ''}
                      The difference includes selection, time in cash, costs and
                      timing; it does not establish investment skill.
                    </p>
                  </div>
                </div>
                          ...
                          {merged.slice(0, visible).map((row) => {
                            ...
                            return (
                              <TableRow key={row.id}>
                                ...
                                <TableCell>
                                  {daysBetween(t.transactionDate, t.filingDate)}
                                  d
                                </TableCell>
                    ...
                    <TabsContent value="timing">
                      <div className="timing-grid">
                        <article>
                          ...
                          <p>
                            The reported day a transaction happened. We estimate
                            buying at that day’s open. The execution time and
                            actual price are generally undisclosed.
                          </p>
                        </article>
                        <article>
                        ...
                        <article>
                          <span className="timeline-number green-text">03</span>
                          <h3>Follower entry</h3>
                          <p>
                            The first market open strictly after filing, plus
                            your extra delay. Weekends and market holidays move
                            the entry to the next available session.
                          </p>
                        </article>
                      </div>
                      <p className="timing-footnote">
                        ...
                        performance gap also reflects different holding windows
                        and available cash; it is not a pure measurement of
                        disclosure delay.
                      </p>
                    </TabsContent>
                  </Tabs>
                ...
                {inspected && selected && (
                  <section className="panel inspection">
                    <div className="panel-heading">
                      <h3>
                        {inspected.ticker} · {date(inspected.transactionDate)}
                      </h3>
                      <Button
                        variant="ghost"
                      ...
                      {[
                        ...
                        <article key={label}>
                          ...
                          {p ? (
                            ...
                            <p>
                              Skipped in this scenario; see experiment export
                              for the reason.
                            </p>
                          )}
                        </article>
